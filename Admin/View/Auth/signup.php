    ...
    <div class="signup-card">
        ...
        <form method="post" onsubmit="" action="../../Controller/handleSignupValidation.php">
            <div class="form-group">
                ...
                <input type="text" class="signup-input" placeholder="Nabil23" name="uname" value="<?php echo $previousValues['username'] ?? ''; ?>">
            ...
            <div class="form-group">
                ...
                <span class="errSpan"  id="ajaxResponse"><?php echo $emailErr; ?></span>
            </div>

            <div class="form-group">
                <label>Security Question</label>
                <select name="sec_question" class="signup-input" >
                ...
                <input class="signup-input" type="text" name="sec_answer" >
                <span class="errSpan" ><?php echo $qansErr; ?></span>
